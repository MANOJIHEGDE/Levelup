      ...
      <div className="header-left-items d-flex align-items-center mxy-30">
        <div className="menubar">
          <svg
            ...
            style={{ width: "100px", height: "100px",paddingTop:"30px"}}
          >
      ...
      <div className="header-rightbar d-flex align-items-center">
        ...
        <div className="profile-menu">
          <div className="profile-img">
            <img
              src="https://media.licdn.com/dms/image/C560BAQGm42k-a5xtOQ/company-logo_200_200/0/1642258530131/gowebknot_logo?e=2147483647&v=beta&t=PWYGMNGfHLZ29rXFGe-mOtMQ49MfFwNnvxO2gMJonKE"
              alt=""
              className="dp mxy-15"
            />
          </div>
